...
const Navbar = () => {
  return (
    <nav className="fixed top-6 inset-x-4 h-14 max-w-screen-xl mx-auto rounded-full bg-background border dark:border-slate-700/70 z-30">
      <div className="flex h-full items-center justify-between px-6 md:px-8">
        {/* Logo with consistent padding */}
        <Link href="/" className="flex-shrink-0 ">
          <span className="text-black font-bold">BlogBD</span>
        </Link>
